...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/favicond.io.png">
...
<body class="authentication-bg" style="background-image: url('assets/images/background image.png'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
